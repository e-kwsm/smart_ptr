...
public:
    ...
    explicit X( int expected, boost::shared_ptr<X> *early_px = nullptr ): destroyed_( 0 ), deleted_( 0 ), expected_( expected )
    {
        ++instances;
...
int main()
{
...

    {
        ...
        BOOST_TEST( boost::get_deleter<X::deleter_type>(early_px) == nullptr );
