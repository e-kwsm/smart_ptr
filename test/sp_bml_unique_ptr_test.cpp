...
int main()
{
    ...
    {
        test_null_unique_ptr<Y>( boost::movelib::unique_ptr<Y, YD>( nullptr, YD() ), boost::movelib::unique_ptr<Y, YD>( nullptr, YD() ) );
        test_null_unique_ptr<Y const>( boost::movelib::unique_ptr<Y, YD>( nullptr, YD() ), boost::movelib::unique_ptr<Y, YD>( nullptr, YD() ) );
        test_null_unique_ptr<void>( boost::movelib::unique_ptr<Y, YD>( nullptr, YD() ), boost::movelib::unique_ptr<Y, YD>( nullptr, YD() ) );
        test_null_unique_ptr<void const>( boost::movelib::unique_ptr<Y, YD>( nullptr, YD() ), boost::movelib::unique_ptr<Y, YD>( nullptr, YD() ) );
    }
